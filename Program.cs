    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                // After each turn judge if there is a winner
                // If no winner keep playing by going to step 1
        ...
        {
            // If we have a winner, announce who won and stop the game
        ...
        static void DrawGameboard(char[] gameMarkers)
        {
            ...
            // Game will have 3 rows and 3 columns will be numbered 1 through 9
